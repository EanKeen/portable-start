function write_config_comments($var, $config) {
  $msg = "Do not edit this file. This file is auto-generated and replaced by scripts in $($var.portableDir)"
  ...
  write_comment_to_config $var $var.cmdUserAliases $msg
  $lines = @(
    ";= `@echo off",
...
function create_config_files($var, $config) {
  ...
  if (Test-Path -Path $var.cmdUserAliases -PathType Leaf) {
    Remove-Item -Path $var.cmdUserAliases
  }
